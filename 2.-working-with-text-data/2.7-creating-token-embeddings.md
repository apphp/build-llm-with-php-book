...
<div align="left"><figure><img src="../.gitbook/assets/2.7-creating-token-embeddings.png" alt="" width="563"><figcaption><p>The text preparation process includes text tokenization, converting text tokens into token identifiers, and converting these identifiers into embedding vectors. In this case, we use previously created token identifiers to obtain embedding vectors.</p></figcaption></figure></div>
